    ...
    <div class="card h-100">
        ...
        <div class="card-body">
            <div class="row d-flex gap-2 justify-content-end">
                <button href="javascript:void(0);" class="btn btn-success col-3" type="button" data-bs-toggle='modal' data-bs-target='#tambahsingle'>
                    <i class='bx bx-user-plus'></i>
                    Tambah (single)</button>
                <button href="javascript:void(0);" class="btn btn-success col-3" type="button" data-bs-toggle='modal' data-bs-target='#tambahmultiple'>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="tambahsingleTitle">Modal title</h5>
