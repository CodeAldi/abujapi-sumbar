...
<div class="card h-100">
    ...
    <div class="card-body">
        <form action="{{ route('berita.kategori-berita.store') }}" method="post">
            @csrf
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>Berita dengan katgori ini</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <button class="dropdown-item" href="javascript:void(0);"
                                        data-bs-target='#edit_kategori_{{ $loop->iteration }}' data-bs-toggle='modal'><i
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahsingleTitle">Edit Kategori Berita</h5>
