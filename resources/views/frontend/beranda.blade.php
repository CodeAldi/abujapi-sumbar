...
<div class="container my-2">
    ...
    <div class="row mb-2">
        <div class="col">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ $item->short }} <a
                                    href="{{ route('berita.baca',['slug'=>$item->slug]) }}"
                                    class="text-oren fw-bold">Selengkapnya</a></p>
                        </div>
                        <div class="card-footer">
                            <small class="text-body-secondary">admin | {{ date_format($item->updated_at, 'd-M-Y H:i:s')
                                }} wib</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="muat mt-3">
                <a href="{{ route('berita.all') }}" class="btn d-block mx-auto text-white rounded-pill"
                    style="background-color: #eaa742;">Muat Lebih
                    Banyak</a>
            </div>
        </div>
        <div class="row">
            <div class="col">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 mt-3">
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <small class="text-body-secondary">admin | {{ date_format($item->updated_at, 'd-M-Y
                                    H:i:s') }} wib</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="muat mt-3 ">
                    <a href="{{ route('kegiatan.all') }}" class="btn d-block text-white rounded-pill"
                        style="background-color: #eaa742;">Muat Lebih
                        Banyak</a>
                </div>
            </div>
